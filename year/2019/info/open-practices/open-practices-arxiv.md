...
* [If you are uploading `TeX` files] Replace the `vgtc.cls` file with the revised the `vgtc.cls` file included in the [updated `laTeX` template here](http://junctionpublishing.org/vgtc/Track/vis-menu.html)
