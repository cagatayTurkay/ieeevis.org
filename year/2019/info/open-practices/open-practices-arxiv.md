...
* [If you are uploading `TeX` files] Replace the `vgtc.cls` file with the file included in the [updated `laTeX` template here](http://junctionpublishing.org/vgtc/Track/vis-menu.html)
